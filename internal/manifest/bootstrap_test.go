...
func TestBootstrapFiles(t *testing.T) {
	...
	t.Run("with utf-16 little endian encoded requirements.txt no change", func(t *testing.T) {
		tmpDir := t.TempDir()
		requirementsPath := filepath.Join(tmpDir, "requirements.txt")
		before, err := os.ReadFile("../../testdata/requirements-utf-16-le.txt")
		require.NoError(t, err)
		test.CopyFile(t, "../../testdata/requirements-utf-16-le.txt", requirementsPath)
