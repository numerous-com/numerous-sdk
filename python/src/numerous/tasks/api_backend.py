...
class APITaskControlHandler(TaskControlHandler):
    ...
    def log(self, task_control, message: str, level: str, **extra_data: Any) -> None:
        ...
        try:
            ...
            logger.log(
                log_level, f"[Task {self.task_instance_id}] {message}", extra=extra_data
            )
    ...
    def update_progress(
        self, task_control, progress: float, status: Optional[str]
    ) -> None:
        """Send progress update to API."""
        try:
            logger.debug(
                f"[Task {self.task_instance_id}] Progress: {progress}%, Status: {status}"
            )
...
class APIConnectedBackend:
    ...
    def fetch_task_inputs(self, task_instance_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Fetched inputs for task {task_instance_id}: {list(inputs_data.keys())}"
            )
            return inputs_data
    ...
    def report_task_result(
        self, task_instance_id: str, result: Any, error: Optional[Exception] = None
    ):
        ...
        try:
            ...
            mutation_input = {"taskInstanceId": task_instance_id, "status": status}
            ...
            if reported_task:
                ...
                logger.warning(
                    f"Unexpected response when reporting result for {task_instance_id}"
                )
    ...
    def upsert_task_instance(
        ...
        try:
            ...
            if inputs:
                ...
                inputs_base64 = base64.b64encode(inputs_json.encode("utf-8")).decode(
                    "utf-8"
                )
    ...
    def force_start_execution(
        self, task_instance_id: str, session_id: str, client_id: str
    ) -> dict:
    ...
    def report_execution_progress(
        self, execution_id: str, progress: float, status_message: str = None
    ) -> dict:
        ...
        try:
            ...
            mutation_input = {"executionId": execution_id, "progress": progress}
    ...
    def complete_execution(self, execution_id: str, result: dict) -> dict:
        ...
        try:
            ...
            variables = {"executionId": execution_id, "result": result_json}
    ...
    def fail_execution(self, execution_id: str, error: str) -> dict:
        ...
        try:
            ...
            variables = {"executionId": execution_id, "error": error}
    ...
    def validate_session_ownership(self, session_id: str, instance_id: str) -> bool:
        ...
        try:
            ...
            variables = {"sessionId": session_id, "instanceId": instance_id}
    ...
    def disconnect_client(self, client_id: str, session_id: str) -> dict:
        ...
        try:
            ...
            variables = {"clientId": client_id, "sessionId": session_id}
...
def api_task_execution_wrapper(task_func, task_name: str, *args, **kwargs):
    ...
    try:
        ...
        logger.info(
            f"Fetching inputs for task {task_name} (instance: {task_instance_id})"
        )
